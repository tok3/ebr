...
class Theme_Ihre_energieberater extends Theme
{


	public $name			= 'Ihre Energieberater';
	public $author			= 'Tobias C. Koch | mms&amp;c.';
	public $author_website	= 'http://mmsetc.de/';
	public $website			= 'http://ihre-energieberater.eu/';
	public $description		= 'ihre-energieberater.eu';
